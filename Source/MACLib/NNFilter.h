...
private:
    ...
    __forceinline int64 CalculateDotProductx16(short * pA, short * pB, intn nOrder);
        ...
        __forceinline void AdaptAVX(int * pM, int * pAdapt, int64 nDirection, intn nOrder);
        __forceinline void AdaptAVXx16(short * pM, short * pAdapt, int64 nDirection, intn nOrder);
        __forceinline int64 CalculateDotProductAVXx16(short * pA, short * pB, intn nOrder);
    #endif
