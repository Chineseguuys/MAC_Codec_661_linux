...
int main(int argc, char* argv[]) 
{
	...
	APE::WAVEFORMATEX wfeAudioFormat; FillWaveFormatEx(&wfeAudioFormat, 0, 44100, 16, 2);
	...
	while (nAudioBytesLeft > 0)
	{
		...
		if (nRetVal != 0)
		{
			wprintf(_T("Error Encoding Frame (error: %I64d)\n"), nRetVal);
			break;
		}
	...
	{
		wprintf(_T("Error finishing encoder.\n"));
	}
